...
$iter2=0;
	while($iter2<=150)
	{
		...
		for ($iter1 = 0; $iter1 <= $totalSize-1; $iter1++) {
			...
			for($iter3=0;$iter3<$totalFilterElements-12;$iter3++){


				if(preg_match($filterStringArray[$iter3],$title))
				{
					...
					$resultArrayDataEntry[$resultArrayCount]['category']= $categoryStringArray[$iter3];
					$resultArrayCount++;
